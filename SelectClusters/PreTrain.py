...
if __name__ == "__main__":
    ...
    parser.add_argument('--divide_cluster', type=int, default=8, help='divide of clusters')
    parser.add_argument('--step_cluster', type=int, default=1, help='step of clusters')
    ...
    for cur_cluster in range(args['num_clusters'] - args['divide_cluster'], args['num_clusters'] + 1, args['step_cluster']):
